...
@pytest.mark.asyncio
async def test_future_episodes_are_skipped(mocker, context, make_callback_query, make_message):
    # Mock datetime.now() to return a fixed date: 2023-01-01
    mock_datetime = mocker.patch("telegram_bot.workflows.search_workflow.tv_flow.datetime")
