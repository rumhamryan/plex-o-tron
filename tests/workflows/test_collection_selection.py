import pytest
from telegram_bot.workflows.search_workflow.movie_collection_flow import _pick_collection_candidate
...
def test_pick_collection_candidate_uploader_consistency(mock_results):
    ...
    candidate = _pick_collection_candidate(results, "2160p", "x265", None, "ConsistentGroup")
