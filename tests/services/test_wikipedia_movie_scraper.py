...
from telegram_bot.services.scrapers import fetch_movie_years_from_wikipedia
...
async def test_fetch_movie_years_handles_titles_with_punctuation(mocker):
    ...
    mocker.patch("wikipedia.page", return_value=_DummyWikiPage("Jumanji: The Next Level"))
