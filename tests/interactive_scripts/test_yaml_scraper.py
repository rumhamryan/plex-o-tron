...
from telegram_bot.services.scrapers import scrape_yaml_site
...
async def main():
    ...
    config_dir = (
        Path(__file__).resolve().parent.parent.parent / "telegram_bot" / "scrapers" / "configs"
    )
    ...
    while True:
        try:
            ...
            limit_str = input("Enter limit for results (default 15, press Enter for default): ")
